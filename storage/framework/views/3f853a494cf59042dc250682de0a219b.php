<?php $__env->startSection('extend-header'); ?>
                    ...
                    <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <div class="bg-indigo-50 flex justify-center items-center w-full">
                                <img class="h-auto max-w-full object-cover" src="<?php echo e($sl->path . '/' . $sl->image); ?>" alt="<?php echo e($sl->title); ?>" >
            ...
            <div class="flex flex-nowrap md:grid overflow-x-auto md:grid-cols-3 gap-4 max-h-[65%]">
                ...
                <?php $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="bg-white border  border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <?php if($b->getFirstImage() !== null): ?>
                                <img class="rounded-t-lg relative mx-auto w-full" src="<?php echo e(asset('assets/images/news/' . $b->getFirstImage())); ?>" alt="" style="object-fit: cover" />
                            <?php else: ?> 
                            <img class="rounded-t-lg relative mx-auto w-full" src="<?php echo e(asset('assets/images/not-found-image.png')); ?>" alt="" style="object-fit: cover" />
                            <?php endif; ?>
                        </a>
                        <span class="bg-oren p-3 rounded-full md:text-sm relative text-white font-bold left-2 -top-10">
                            <?php echo e($b->getCreatedAtFormated()); ?>

                        </span>
                        <div class="p-5 w-72 md:w-full">
                            <a href="#">
                                <h5 class="mb-2 text-base md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <?php echo e($contentid->title ?? $b->title); ?>

                                </h5>
                            </a>
                            <p class="mb-3 text-sm md:text-base font-normal text-gray-700 dark:text-gray-400">
                                <?php echo e(Str::limit(strip_tags($contentid->body ?? $b->body), 250, '...')); ?>
    ...
    <section class=" border-gray-200 my-20 py-20">
        ...
        <div class="w-full container mx-auto px-4">
            ...
            <div class="flex flex-row  gap-4 overflow-x-auto">
                ...
                <img class="self-center md:w-[20%]" src="<?php echo e(asset('assets/images/logo/bos.png')); ?>" alt="logo-bos">

                <img class="self-center md:w-[20%]" src="<?php echo e(asset('assets/images/logo/dapodik-logo.png')); ?>"
                    alt="logo-bos">

                <img class="self-center md:w-[20%]" src="<?php echo e(asset('assets/images/logo/logo-sipintar.png')); ?>"
                    alt="logo-bos">

                <img class="self-center md:w-[20%]" src="<?php echo e(asset('assets/images/logo/pngtree-merdeka.png')); ?>"
                    alt="logo-bos">

                <img class="self-center md:w-[20%]" src="<?php echo e(asset('assets/images/logo/rumah-belajar.png')); ?>"
                    alt="logo-bos">
...
<?php $__env->startSection('extend-script'); ?>
    <script>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web\sdmuhsapen\resources\views/frontend/pages/home.blade.php ENDPATH**/ ?>