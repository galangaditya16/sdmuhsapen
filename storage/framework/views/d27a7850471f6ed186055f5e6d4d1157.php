<nav class="bg-dark-blue dark:bg-gray-900 fixed w-full z-20 top-0">
    <div class="container flex flex-wrap items-center justify-between mx-auto p-1">
        <a href="<?php echo e(url('/')); ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="<?php echo e(asset('assets/images/LOGO_SAPEN.png')); ?>" class="h-16" alt="Flowbite Logo">
        </a>
                ...
                <li>
                    ...
                    <div id="dropdownNavbar" class="z-10 hidden font-bold bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="<?php echo e(route('profile')); ?>" class="block px-4 py-2 font-bold hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                    Profil Sekolah
                                </a>
                            </li>
                            <li>
...
<?php /**PATH D:\web\sdmuhsapen\resources\views/frontend/layouts/navbar.blade.php ENDPATH**/ ?>