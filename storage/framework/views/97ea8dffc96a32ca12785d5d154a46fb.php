            ...
            <div class="grid gap-12 md:grid-cols-3 sm:gap-6 sm:grid-cols-1 :grid-cols-1 md:flex-auto md:p-2">
                <div>
                        <a href="<?php echo e(url('/')); ?>" class="flex items-center">
                            <img src="<?php echo e(asset('assets/images/LOGO_SAPEN.png')); ?>" class="h-20 me-3" alt="<?php echo e('Logo' . env('APP_NAME')); ?>" />
                            <span class="self-center text-2xl font-semibold"><?php echo e(env('APP_NAME')); ?></span>
                        </a>
                ...
                <div>
                        ...
                        <div class="w-80 bg-kuning-muda rounded-lg p-3 mx-auto">
                                <img class="mx-auto my-2 w-64" src="<?php echo e(asset('assets/images/equalizer.gif')); ?>">
    ...
    <div class="w-full px-4 py-2 bg-biru-tua">
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-black mx-auto">
                Copyrigth © <?php echo e(date('Y')); ?> <?php echo e(env('APP_NAME')); ?>
...
<?php /**PATH D:\web\sdmuhsapen\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>