...
@section('content')
    ...
    <section class=" border-gray-200 mb-20 mt-0 content-center">
        <!--HTML CODE-->
        <div
            class="w-full md:w-[75%] container mx-auto px-4 absolute top-52 md:top-[25%] md:left-[5%] lg:top-[25%] lg:left-[25%] z-20">
            ...
            <a href="{{ route('profile') }}">
                <button type="button"
                    class="text-white ml-3 my-5 font-bold bg-biru-tua hover:bg-blue-900 hover:cursor-pointer rounded-lg text-sm px-5 py-2 text-center md:mx-1">
            ...
            <div class="relative w-full h-full md:h-[835px] z-[18] overflow-hidden">
                ...
                <div class="default-carousel w-full min-h-svh h-full" data-carousel="slide">
                    @foreach ($slider as $indexSlider => $sl)
                        <div class="bg-cover shrink-0 duration-1000 ease-in-out hidden"
                            {{ $indexSlider == 0 ? "data-carousel-item='active'" : 'data-carousel-item' }}
    ...
    <section class=" border-gray-200 py-10">
        <div class="w-full block container mx-auto px-4">
            <h1 class="text-4xl font-bold my-3 text-black text-center mx-auto my-10">{{ __('message.galeri_kegiatan') }}
            </h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 md:grid-rows-3 gap-2 min-h-[560px] h-[560px]">
                @forelse ($gallerys as $key => $value)
                    @if ($key == 2 || $key == 3)
                        <div class="relative col-span-2 row-span-2 bg-no-repeat bg-center bg-cover"
                            style="background-image: url('{{ asset('assets/images/gallery/thumbnail' . '/' . $value->thumbnail) }}') ">
                            <a href="{{ route('galeryDetail', $value->slug_id) }}">
                                <div
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <p class="italic text-black text-sm">
                                            {{ Carbon\Carbon::parse($value->created_at)->format('l, d F Y') }}</p>
        ...
        <div class="w-full container mx-auto px-4">
            <div class="grid md:grid-cols-2 grid-rows-auto gap-28">
                ...
                <div class="">
                    ...
                    <div class="default-carousel relative" data-carousel="slide">
                        <div class="relative overflow-hidden w-full min-h-[500px] md:min-h-[350px] justify-self-center">
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <p class="text-base mt-3 text-justify">
                                    “SD terbaik di Yogyakarta, bahkan Nasional dengan prestasi yang istimewa. Kepala Sekolah
                                    dan
                                    Guru-guru amat perhatian dengan murid-muridnya untuk melejitkan menggali potensinya.
                                    Terima kasih
                                    Bapak Ibu Guru yang telah mendidik anak-anak saya disini dengan baik, disiplin, islami,
                                    amanah,
                                ...
                                <div class="rate flex flex-row">
                                    <svg class="w-6 h-6 text-kuning-tua" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                ...
                                <h3 class="text-2xl font-bold mt-3 text-dark-blue">Prof. Dr. Wuri Wuryandani, S.Pd., M.Pd.
                                </h3>
                                <p class="text-base">
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                ...
                                <h3 class="text-2xl font-bold mt-3 text-dark-blue">Prof. Fathul Wahid, ST., M.Sc., Ph.D.
                                </h3>
                                <p class="text-base">
                                    Rektor Universitas Islam Indonesia <br>
                                    Orang tua dari alumni Dr. Awanis Akalili, S.I.P., M.A dan Abiyyu Amajida, M.Or.
                                    (kandidat doktor FIK UNY)
                                </p>
                                <div class="rate flex flex-row">
                                    <svg class="w-6 h-6 text-kuning-tua" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                ...
                                <h3 class="text-2xl font-bold mt-3 text-dark-blue">Prof. Ir. Panut Mulyono. M.Eng., D.Eng.,
                                    IPU, ASEAN Eng</h3>
                                <p class="text-base">
                        ...
                        <!-- Slider controls -->
                        <button type="button"
                            class="hidden md:flex absolute top-0 -left-[65px] z-30 items-center justify-center h-full px-2 cursor-pointer group focus:outline-none"
                            data-carousel-prev>
                            <span
                                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                <svg class="w-4 h-4 text-dark-blue  rtl:rotate-180" aria-hidden="true"
                        ...
                        <button type="button"
                            class="hidden md:flex absolute top-0 -right-[65px] z-30 items-center justify-center h-full px-2 cursor-pointer group focus:outline-none"
                            data-carousel-next>
                            <span
                                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                <svg class="w-4 h-4 text-dark-blue dark:text-gray-800 rtl:rotate-180" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a target="_blank"
                        href="https://www.google.com/maps/place/SD+Muhammadiyah+Sapen/@-7.7859359,110.3899218,17z/data=!4m8!3m7!1s0x2e7a59dafb0f533f:0x703ab4cd80139883!8m2!3d-7.7859359!4d110.3924967!9m1!1b1!16s%2Fg%2F11f3rdnn6m?entry=ttu&g_ep=EgoyMDI1MDEwOC4wIKXMDSoASAFQAw%3D%3D">
                        <button type="button"
    ...
    <section class=" border-gray-200 my-10 pt-20">
        ...
        <div class="w-full container mx-auto px-4">
            ...
            <div class="flex flex-row gap-4">
                ...
                <div class="w-full md:w-10/12 mx-auto mt-8 bg-white" id="accordion-color" data-accordion="collapse"
