            ...
            <div class="md:w-1/2 space-y-6">
                ...
                <div
                    ...
                    <div class="w-5/6">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=628112642733&text=Halo%2C+saya+ingin+bertanya+mengenai+info+PPDB+di+SD+Muhammadiyah+Sapen&type=phone_number&app_absent=0"
                            target="_blank">
                ...
                <form action="{{ route('send.message') }}" method="post" class="space-y-6">
                    ...
                    <div class="flex gap-x-1.5">
                        ...
                        <div class="flex items-center border-b border-black py-1 w-full">
                            <input name="email"
                                class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                                type="text" placeholder="Email" aria-label="Email" required>
                        </div>
                    </div>
                    <div class="flex items-center border-b border-black py-1">
                        <select name="shown"
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mt-10">
                <a href="https://www.instagram.com/{{ $contact->instagram ?? '#' }}/" target="_blank">
                    <div
                        class="flex border rounded-2xl py-3 px-2.5 border-black bg-white hover:bg-biru-tua hover:text-white">
                        <div class="w-1/6 flex justify-center items-center">
                ...
                <a href="http://95.154.195.3:5988/" target="_blank" rel="noopener noreferrer">
                  <div class="flex items-center border border-black rounded-2xl p-3 bg-white hover:bg-blue-800 hover:text-white transition duration-200">
                    ...
                    <div class="ml-4 flex-1">
                      <p class="text-xl font-bold">I Love Radio 1 (Germany)</p>
                    </div>
                    <div class="w-12">
                      <audio controls autoplay>
                        <source src="http://95.154.195.3:5988/" type="audio/mpeg">
