...
@section('content')
  ...
  <section class="w-10/12 xl:w-9/12 mx-auto grid grid-cols-1 gap-y-14 md:my-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-9 md:gap-y-0 gap-x-9">
      <img class="object-cover w-[530px] h-[615px] rounded-3xl" src="{{ asset('assets/images/teachers/grand-teacher.jpg')}}" alt="grand-teacher.jpg">
      <div class="space-y-5">
        ...
        <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus obcaecati placeat illo maiores dolore minus quas harum maxime unde eos. Maiores explicabo quo culpa perspiciatis. Esse ut odit libero quisquam!
        ...
        Unde, placeat laudantium? Doloremque assumenda sapiente velit ex. Architecto ex nihil ullam! Rerum esse fuga quia cum vero repellat, nobis nesciunt dignissimos voluptatem numquam ipsa fugiat, deserunt tempora iure dolorum! </p>
      </div>
    </div>
    <p>
    ...
    Similique delectus cum a totam corrupti molestias tenetur inventore. Maxime similique nihil beatae esse, sequi vitae debitis voluptatum harum quibusdam provident dolorum at! Voluptatem ab nam, hic itaque laborum iste!
    Quaerat, mollitia adipisci amet eveniet nihil, accusantium omnis fugiat unde illo iusto quod delectus provident minus non iste laudantium! Nulla in placeat, mollitia nihil nesciunt fugit deleniti eaque illo commodi.
    </p>
    <img class="h-64 w-full object-cover rounded-3xl" src="{{ asset('assets/galeri/galery-1.jpeg') }}" alt="galeri-1.jpeg">
  </section>
