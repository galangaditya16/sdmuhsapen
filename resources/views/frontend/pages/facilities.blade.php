...
@section('content')
    ...
    <section class="container mx-auto grid grid-cols-1 gap-y-14 md:my-20 mb-14">
        <p class="lg:w-1/2 mx-auto text-center text-lg">SD Muhammadiyah Sapen dilengkapi dengan berbagai fasilitas penunjang
            pembelajaran yang sudah distandarisasi tinggi. Hal ini membuat kami mendapatkan akreditasi A.</p>
                        ...
                        <div class="relative w-4/5 lg:w-[628px] card-container">
                            <div class="card-wrapper relative w-full h-[332px]">
                                ...
                                <div class="card-back rounded-3xl bg-biru-tua">
                                    <div
                                        class="w-full h-full p-10 md:text-xl text-white space-y-5 scrollable-container-with-custom-scrollbar">
