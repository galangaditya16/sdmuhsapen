...
@section('content')
  ...
  <section class="container mx-auto grid grid-cols-1 gap-y-14 md:my-20 mb-14">
    <p class="lg:w-1/2 mx-auto text-center text-lg">SD Muhammadiyah Sapen dilengkapi dengan berbagai fasilitas penunjang pembelajaran yang sudah distandarisasi tinggi. Hal ini membuat kami mendapatkan akreditasi A.</p>
