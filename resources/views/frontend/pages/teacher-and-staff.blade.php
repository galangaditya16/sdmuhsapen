...
@section('content')
  ...
  <section class="container mx-auto grid grid-cols-1 gap-y-14 md:my-20">
      ...
      <div class="flex justify-between text-center">
        <div class="my-auto">
          <button id="left-button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10 md:size-20 text-oren">
        ...
        <div id="carousel" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-x-5 md:gap-5 transition-transform duration-500 ease-in-out">
          <div class="mx-auto">
            <div style="background-image: url('{{asset('assets/images/teachers/grand-teacher.jpg')}}');" class="bg-no-repeat bg-center bg-cover rounded-2xl overflow-hidden w-72 md:w-60 xl:w-72 max-w-[300px] h-[450px] relative">
              <div class="bg-biru-tua absolute bottom-0 w-full h-32 grid grid-cols-1 justify-between">
                <p class="text-oren font-bold text-2xl">Agung Rahmanto, S.H., M.Pd.</p>
                <p class="text-white font-bold">Kepala SD Muh Sapen</p>
              </div>
    ...
    <div class="">
      <div class="mb-14">
        <p class="text-3xl text-biru-tua place-self-center mx-auto w-fit">Guru Kelas</p>
        <div class="block w-32 h-1 bg-biru-tua mx-auto mt-2"> </div>
      </div>
      <div></div>
      <div class="flex justify-between text-center">
    ...
    <div class="">
      <div class="mb-14">
        <p class="text-3xl text-biru-tua place-self-center mx-auto w-fit">Guru Mata Pelajaran</p>
        <div class="block w-32 h-1 bg-biru-tua mx-auto mt-2"> </div>
      </div>
      <div></div>
      <div class="flex justify-between text-center">
