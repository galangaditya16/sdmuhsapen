...
@section('content')
    <div class="col-md-12">
        <form class="card" method="POST" action="{{ route('content.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                    ...
                    <div>
                        <select class="form-select" name="id_category">
                            @forelse ($categorys as $category)
                                <option value="{{ $category->id_category_content }}">{{ $category->title }}</option>
                            @empty
                ...
                {{-- <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="slug" class="form-control" aria-describedby="slug"
                            placeholder="Enter Name Slug" value="{{ old('title') }}">
                        @error('slug')
                            <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <textarea class="content" name="body_translite">
                        </textarea>
                    </div>
